...
A few months ago, I wrote a [blog post](www.ericekholm.com/blog/youtube-transcripts) describing how to pull transcripts from each video in a Youtube playlist. I'm not going to go over that part again, so if you're curious about how to get the data, check out that post.
...
ymh <- vroom::vroom("~/Data/YMH/Data/ymh_trans.csv") %>%
  filter(ep_num > 370)
