...
During grad school, I discovered a love for working with data -- exploring, visualizing, modeling, and communicating. I mostly work in `R`, but I also dabble in SQL, Python, and HTML/CSS. I really enjoy discovering new `R` (and Python) packages and slowly (all progress is slow with a baby in the house) learning new things.

## Projects and Publications

If you're interested in seeing some of the things I've worked on, check out my [publications page](https://www.ericekholm.com/pubs.html), my [visualizations page](https://www.ericekholm.com/viz.html), or my [blog](https://www.ericekholm.com/blog.html).

## Consulting and Contracted Work

Time permitting, I occassionally do some consulting and contract work. Although I specialize in educational research, I'm generally proficient with  a wide range of statistical modeling frameworks, data visualization, and dashboard design (via `{shiny}`), among other things. If you're interested in working with me, [send me an email](mailto:eric.ekholm@gmail.com)
